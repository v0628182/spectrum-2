...
warzone_audio::EngineParams toCppParams(const WzaEngineParams& params)
{
    ...
    out.lowShelfFreqHz = params.lowShelfFreqHz;
    out.lowMidFreqHz = params.lowMidFreqHz;
    out.lowMidQ = params.lowMidQ;
    out.weaponMidFreqHz = params.weaponMidFreqHz;
    out.weaponMidQ = params.weaponMidQ;
    out.stepBodyFreqHz = params.stepBodyFreqHz;
    out.stepBodyQ = params.stepBodyQ;
    out.stepClarityFreqHz = params.stepClarityFreqHz;
    out.stepClarityQ = params.stepClarityQ;
    out.weaponAirFreqHz = params.weaponAirFreqHz;
    out.weaponAirQ = params.weaponAirQ;
    out.protectionAttackMs = params.protectionAttackMs;
    out.protectionReleaseMs = params.protectionReleaseMs;
    out.boostAttackMs = params.boostAttackMs;

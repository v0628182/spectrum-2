...
const PRESETS: Preset[] = [
  ...
  },
  {
    ...
    values: {
      weaponOnlyMode: 1, changeIntensity: 125, subtletyAmount: 40, wetMix: 96,
      footstepEnhance: 0, actionDetail: 0, gunshotReduction: 92, explosionReduction: 0,
      detectionSensitivity: 100, outputCeilingDb: -0.5, stepBodyBoostDb: 0, stepClarityBoostDb: 0,
      stepLowBodyBoostDb: 0, stepLowMidBoostDb: 0, weaponMidCutDb: -28, weaponAirCutDb: -24,
      sustainedHoldMs: 360, masterDuckDb: -14, impactDuckDb: -10, footstepLevelerAmount: 0,
      footstepTargetRmsDb: -24, footstepMaxLiftDb: 0, footstepLevelerSpeedMs: 60,
      stabilityAmount: 96, spectralFloorDb: -30, stftCutoffHz: 2800, stftPreserveDb: 0,
      transientKill: 35, spectralFloorStab: -28, stableReleaseMs: 170, footstepGuardAmount: 100,
      protectionPasos: 100, maxCutStepDb: 4, outputTrimDb: 0, residualReductionDb: 0,
      balanceLowDb: 0, balanceMidDb: 0, balanceHighDb: 0,
      ...
      weaponAirFreqHz: 7200, weaponAirQ: 2.4,

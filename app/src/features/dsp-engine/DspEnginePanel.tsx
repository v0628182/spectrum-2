...
const PRESETS: Preset[] = [
  {
    ...
    values: {
      ...
      stepLowBodyBoostDb: 0, stepLowMidBoostDb: 0, weaponMidCutDb: -32, weaponAirCutDb: -26,
      ...
      stabilityAmount: 25, spectralFloorDb: -32, stftCutoffHz: 2800, stftPreserveDb: 0,
      transientKill: 35, spectralFloorStab: -32, stableReleaseMs: 0.5, footstepGuardAmount: 100,

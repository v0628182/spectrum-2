...
const PRESETS: Preset[] = [
  {
    ...
    label: 'TRIPLE LAYER - Solo Disparo',
    values: {
      weaponOnlyMode: 1, changeIntensity: 160, subtletyAmount: 12, wetMix: 100,
      ...
      sustainedHoldMs: 24, masterDuckDb: -18, impactDuckDb: -14, footstepLevelerAmount: 0,
      ...
      transientKill: 100, spectralFloorStab: -34, stableReleaseMs: 8, footstepGuardAmount: 100,
      ...
      protectionAttackMs: 0.5, protectionReleaseMs: 8,

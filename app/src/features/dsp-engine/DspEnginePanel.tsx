...
const PRESETS: Preset[] = [
  ...
  },
  {
    ...
    label: 'Arma Selectiva - Pasos Vivos',
    values: {
      changeIntensity: 115, subtletyAmount: 45, wetMix: 95,
      footstepEnhance: 100, actionDetail: 22, gunshotReduction: 92, explosionReduction: 86,
      detectionSensitivity: 100, outputCeilingDb: -0.8, stepBodyBoostDb: 14, stepClarityBoostDb: 21,
      stepLowBodyBoostDb: 10, stepLowMidBoostDb: 9, weaponMidCutDb: -34, weaponAirCutDb: -30,
      sustainedHoldMs: 540, masterDuckDb: -18, impactDuckDb: -20, footstepLevelerAmount: 100,
      footstepTargetRmsDb: -15, footstepMaxLiftDb: 12, footstepLevelerSpeedMs: 8,
      stabilityAmount: 92, spectralFloorDb: -38, stftCutoffHz: 2600, stftPreserveDb: 2,
      transientKill: 65, spectralFloorStab: -34, stableReleaseMs: 220, footstepGuardAmount: 96,
      protectionPasos: 96, maxCutStepDb: 6, outputTrimDb: -6, residualReductionDb: -3,
      balanceLowDb: 0, balanceMidDb: 0, balanceHighDb: 1,
      lowShelfFreqHz: 220, lowMidFreqHz: 650, lowMidQ: 0.75,
      weaponMidFreqHz: 1700, weaponMidQ: 1.25,
      stepBodyFreqHz: 1550, stepBodyQ: 1.6,
      stepClarityFreqHz: 3600, stepClarityQ: 2.2,
      weaponAirFreqHz: 6200, weaponAirQ: 1.35,
      protectionAttackMs: 2, protectionReleaseMs: 150,
      boostAttackMs: 5, boostReleaseMs: 130,
      limiterReleaseMs: 45, stereoWidth: 100,
    },
    flags: { protectionExtreme: true, spectralMaskEnabled: true, debugLogging: true },
  },
  {

...
const PRESETS: Preset[] = [
  ...
  },
  {
    ...
    values: {
      weaponOnlyMode: 1, changeIntensity: 170, subtletyAmount: 10, wetMix: 100,
      footstepEnhance: 0, actionDetail: 0, gunshotReduction: 100, explosionReduction: 0,
      detectionSensitivity: 100, outputCeilingDb: -0.5, stepBodyBoostDb: 0, stepClarityBoostDb: 0,
      stepLowBodyBoostDb: 0, stepLowMidBoostDb: 0, weaponMidCutDb: -34, weaponAirCutDb: -30,
      sustainedHoldMs: 34, masterDuckDb: -20, impactDuckDb: -16, footstepLevelerAmount: 0,
      footstepTargetRmsDb: -24, footstepMaxLiftDb: 0, footstepLevelerSpeedMs: 60,
      stabilityAmount: 0, spectralFloorDb: -34, stftCutoffHz: 2800, stftPreserveDb: 0,
      transientKill: 100, spectralFloorStab: -34, stableReleaseMs: 12, footstepGuardAmount: 100,
      protectionPasos: 100, maxCutStepDb: 24, outputTrimDb: 0, residualReductionDb: 0,
      balanceLowDb: 0, balanceMidDb: 0, balanceHighDb: 0,
      lowShelfFreqHz: 220, lowMidFreqHz: 900, lowMidQ: 1.2,
      weaponMidFreqHz: 2450, weaponMidQ: 3.0,
      stepBodyFreqHz: 1550, stepBodyQ: 1.6,
      stepClarityFreqHz: 3600, stepClarityQ: 2.2,
      weaponAirFreqHz: 7600, weaponAirQ: 2.7,
      protectionAttackMs: 0.5, protectionReleaseMs: 12,
  ...
  {
    id: 'mi_clean_shot_anti_mareo',
    label: 'MI CLEAN SHOT - Anti Mareo',
    values: {
      weaponOnlyMode: 1, changeIntensity: 150, subtletyAmount: 22, wetMix: 100,
      footstepEnhance: 0, actionDetail: 0, gunshotReduction: 100, explosionReduction: 0,
      detectionSensitivity: 100, outputCeilingDb: -0.5, stepBodyBoostDb: 0, stepClarityBoostDb: 0,
      stepLowBodyBoostDb: 0, stepLowMidBoostDb: 0, weaponMidCutDb: -30, weaponAirCutDb: -23,
      sustainedHoldMs: 22, masterDuckDb: -15, impactDuckDb: -11, footstepLevelerAmount: 0,
      footstepTargetRmsDb: -24, footstepMaxLiftDb: 0, footstepLevelerSpeedMs: 60,
      stabilityAmount: 0, spectralFloorDb: -32, stftCutoffHz: 2800, stftPreserveDb: 0,
      transientKill: 88, spectralFloorStab: -32, stableReleaseMs: 10, footstepGuardAmount: 100,
      protectionPasos: 100, maxCutStepDb: 18, outputTrimDb: 0, residualReductionDb: -6,
      balanceLowDb: 0, balanceMidDb: 0, balanceHighDb: 0,
      lowShelfFreqHz: 220, lowMidFreqHz: 900, lowMidQ: 1.15,
      weaponMidFreqHz: 2400, weaponMidQ: 2.6,
      stepBodyFreqHz: 1550, stepBodyQ: 1.6,
      stepClarityFreqHz: 3600, stepClarityQ: 2.2,
      weaponAirFreqHz: 7200, weaponAirQ: 2.1,
      protectionAttackMs: 0.5, protectionReleaseMs: 10,
      boostAttackMs: 0.5, boostReleaseMs: 0.5,
      limiterReleaseMs: 0.5, stereoWidth: 100,
    },
    flags: { protectionExtreme: true, spectralMaskEnabled: true, debugLogging: true },
